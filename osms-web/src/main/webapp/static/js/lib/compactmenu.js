			...
			$("ul > li", $m).each(function () {
				if ($("li", $(this)).size() > 0) {
					...
					subList.attr({ 'class' : 'sub', 'id': 's' + divId})
						.prepend("<li class='previous'><a class='back' data-main=\"" + divId + "\" href=\"#\">&laquo; Back</a></li><li class='selAdv'><span class='advertiser'>SELECT ADVERTISER</span></li><li><div class='searchBox'><input id='searchBox' type='text' placeholder='Search Advertiser'/></li>"); //Add a link to previous Element
					/**
